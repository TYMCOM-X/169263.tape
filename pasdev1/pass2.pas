...
var
    ...
    ind: integer; (* Counts subr call arguments. *)
...
begin
  ...
  exception
    ...
    stack_overflow: begin
      rewrite (tty);
      writeln (tty, '?The shaping/optimizing pass of the compiler has exceeded its available');
    ...
    io_error: begin
      rewrite (tty);
      writeln (tty, '?The shaping/optimizing pass of the compiler has encountered an I/O problem.');
      case exiostatus of
	io_rewr: begin
