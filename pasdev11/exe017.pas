...
(* test ln(maximum double precision), ln(minimum double precision),
   ...
   d_lib_rslt:=8.80288617707607184e+01;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   ...
   d_rslt:=rslt;
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=4.36682645670376042e+01;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   lib_rslt:=d_lib_rslt;
   ...
   d_rslt:=ln(d_arg1);
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=-6.21697874688087424e+01;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,d_format);
   arg1:=s_min;
   strg_arg1:=s_min_str;
   ...
   d_rslt:=rslt;
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=-4.14465316280791178e+01;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   lib_rslt:=d_lib_rslt;
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,s_format);
   fctn:=log10;
   ...
   d_rslt:=log(d_arg1);
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=3.82304489152654972e+01;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,d_format);
   arg1:=s_max;
   strg_arg1:=s_max_str;
   ...
   d_rslt:=rslt;
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=1.89648863357557258e+01;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   lib_rslt:=d_lib_rslt;
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,s_format);
   d_arg1:=d_min;
   ...
   d_rslt:=log(d_arg1);
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=-2.69999956388015705e+01;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,d_format);
   arg1:=s_min;
   strg_arg1:=s_min_str;
   ...
   d_rslt:=rslt;
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=-1.79999999801033610e+01;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   lib_rslt:=d_lib_rslt;
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,s_format);
...
(* test sqrt(maximum double precision), sqrt(minimum double precision),
   ...
   d_rslt:=sqrt(d_arg1);
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=1.30384047186463043e+19;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,d_format);
   arg1:=s_max;
   strg_arg1:=s_max_str;
   ...
   d_rslt:=rslt;
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=3.03698864318639761e+09;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   lib_rslt:=d_lib_rslt;
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,s_format);
   d_arg1:=d_min;
   ...
   d_rslt:=sqrt(d_arg1);
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=3.16229353805258242e-14;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,d_format);
   arg1:=s_min;
   strg_arg1:=s_min_str;
   ...
   d_rslt:=rslt;
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=1.00000002290685220e-09;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   lib_rslt:=d_lib_rslt;
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,s_format);
...
(* test arctan(max double precision) and arctan(max single precision) *)
   ...
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=1.57079632679489661e+00;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,d_format);
   arg1:=s_max;
   strg_arg1:=s_max_str;
...
(* test maximum(double precision) ** minimum(double precision) and
   ...
   arg2:=s_min;
   rslt:=arg1 ** arg2;
   d_lib_rslt:=1.00000000000000003e+00;
   lib_rslt:=d_lib_rslt;
   d_rslt:=rslt;
   strg_arg1:=s_max_str;
   strg_arg2:=s_min_str;
...
(* test sine(2**14) *)
   fctn:=sine;
   funct_name:='SINE';
   d_arg1:=1.04857600000000000e+06;
   strg_arg1:=hexonly(address(d_arg1),d_format);
   d_rslt:=sin(d_arg1);
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=3.30493140021734667e-01;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,d_format);
   arg1:=d_arg1;
   rslt:=sin(arg1);
...
(* test 5.0 * 0.1 *)
   ...
   d_arg1:=5.0;
   strg_arg1:=hexonly(address(d_arg1),d_format);
   d_arg2:=1.00000001490116119e-01;
   strg_arg2:=hexonly(address(d_arg2),d_format);
   d_rslt:=d_arg1 * d_arg2;
   strg_rslt:=hexonly(address(d_rslt),d_format);
   d_lib_rslt:=5.00000007450580597e-01;
   strg_lib_rslt:=hexonly(address(d_lib_rslt),d_format);
   check_precision(d_d,strg_rslt,d_d,strg_lib_rslt,d_format);
   arg1:=d_arg1;
   arg2:=d_arg2;
