...
type		(* ranges of basic operand types *)
  byte = -"80.."7F;	(* 8 bits *)
  word = -"8000.."7FFF;	(* 16 bits *)
  longword = -"80000000.."7FFFFFFF; (* 32 bits *)
  uns_byte = 0.."ff;
  uns_word = 0.."ffff;
  uns_longword = 0.."ffffffff;
  disp_range = -"80000000.."7fffffff;	(* range of displacement mode offsets *)

type
  registers = 0..16;
  set_of_registers = set of registers;
  reg_set_vector = array [index_range] of set_of_registers;
  reg_selector = 0.."11;		(* registers + special values, see consts below *)
  opc_range = 0.."FF;                  (* binary range of opcode values *)
...
const
  ...
  r1 = 1;
  r0 = 0;
  noreg (* : reg_selector *) := "10;		(* no register assigned, no indexing, etc. *)
  anyreg (* : reg_selector *) := "11;		(* invites any register assignment *)
  ...
  int_nil: code_address := -"10000000;	(* nil defined with base type integer *)
  int_nilf: code_address := -"10000000;	(* ord ( nilf ) for target machine *)
...
(* 	  register_sc,                          (* field is register number *)
  ...
  psect_type = (
	...
	data_psect,	(* same as static_psect, but for datamodules *)
	...
	packed record
	  ...
	  case kind: code_types of
	    ...
	    instruction:
	      ( opcode: opc_range;
		noperands:0..6;
		operands: array[1..6] of addr_desc);	(* short allocated *)
	    ...
	    stringword, pstringword:
	      (  stringlen: line_index;
		 strvalue: packed array[1..10] of char);	(* short allocated *)
