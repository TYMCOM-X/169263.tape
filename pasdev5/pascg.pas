...
$PAGE depcst
public procedure depcst (konsttyp: cstclass; var fattr:attr);
...
$PAGE support
public procedure support(fsupport: supports);
...
$PAGE makecode
public procedure makecode(finstr: instrange; fac: acrange; var fattr: attr);
...
(*$Y4	    IF NOT DBLREAL THEN	*)
	      mac3(finstr,fac,0)
(*$Y4	    ELSE IF FINSTR = 200B (*MOVE*) THEN
...
$PAGE store
public procedure store(fac: acrange; var fattr: attr);
