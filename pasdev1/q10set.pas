...
begin
  ...
  if aconstp (bit_width, const_width) then
    gen_ri (hrli, reg, #O1000000 - ((const_width + 35) div 36))
  else begin
...
var
  ...
  j, real_upb_plus_1, max_const_len, min_val, max_val:    integer;
  temp_descr:           set_desc;
...
function gen_cst_set (set_word: set_word_array; word_count: integer): addr_desc;
