...
var
  l, r, i, j: integer; (* Index variables. *)
  stack: array [1..40] of integer;
  stack_top: 0 .. 40;
  done: boolean;
  v, t: map_record;
...
procedure print_entry ( index: integer; map_addr_to_line: boolean );
...
$PAGE map_close
(*  MAP CLOSE closes the map file preparatory to printing it.  *)

public procedure map_close;
