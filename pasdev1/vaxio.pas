...
var
  ...
  reg: registers;
  addr_ref: addr_ptr;
  ix, low_val, high_val: integer;
  parmsize: parm_range;
  rts: rt_symbol;
  comp_options: record
    case boolean of
      true:  (opt_val: integer);
...
var
  ...
  mask: packed record
    case integer of
      1: (int: integer);
      2: (left_hw: 0..#O3777777; (* leftmost 20 bits *)
          right_hw: 0..#O177777);        (* rightmost 16 bits *)
...
begin
  ...
  (* If the operawas a PUTSTRING, we must copy the temporary
