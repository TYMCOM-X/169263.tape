...
(*$y7
procedure complete_labelling (var lnumber: int_type);
...
procedure complete_labelling (var lnumber: int_type);
 ...
 begin
  ...
  while node^.opcode <> end_block do begin
	...
	begin
	  lnumber := lnumber + 1;
	  node^.block_order_number := lnumber;
...
public procedure make_basic_blocks (var label_numbering: int_type);

 begin
  explode_booleans;
  complete_labelling (label_numbering);
