...
E
M 5 179 #TASK
),N),$ind +17#literal(#ind_flag,1)#assign(#ind_amt,-17)#par(1,-13)Description:\&&)&&~A")#if("#nec("#upc(~A!#if("#ind_flag,$IND #ind_amt$SKIP 1#undef(#ind_flag))$need 8#sect(
E
E
E
E
...
E
M 7 194 #ACTUAL
$ind -4$skip$justify~A"),6),\,\\)&)\\\\~A!),8),#if("#gtn("#length(~A!&#if("#ltn("#length(~A!#if("#ind_flag,$IND #ind_amt$SKIP 1#undef(#ind_flag))$justify left$ind +4#par(1,0)Actual:\\\\\\\\
E
E
E
M 11 203 #FIGURE_POP
...
E
M 9 277 #SCHEDULE
$ind -4$justify~A"),6),\,\\)&)\\\\~A!),8),#if("#gtn("#length(~A!&&)#if("#ltn("#length(~A!,&Rescheduled:\\\~A!,1),$SKIP 1$need 3\\\\\\\\\\\\\^u\\Start\\\|u\\\\^uCompletion|u$SKIP 1Scheduled:\\\\\~A##if("#ind_flag,$IND #ind_amt#undef(#ind_flag))$justify left$ind +4#if("#eqc(
E
E
M 9 138 #ENDLEVEL
...
E
M 5 77 #NAME
))#beginlevel~A!#if("#ind_flag,$IND #ind_amt#undef(#ind_flag))#sect("#upc(
E
M 9 143 #PROGRESS
$skip$ind +4#literal(#ind_flag,1)#assign(#ind_amt,-8)~A!#if("#ind_flag,$IND #ind_amt#undef(#ind_flag))$ind +4$skip 1$need 4Progress\--\&
E
E
M 8 186 #ENDITEM
