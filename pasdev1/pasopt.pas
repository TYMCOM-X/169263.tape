...
var
  ...
  function sum_test ( i: expr; var base: expr; var cst: integer ): boolean;
  begin
    with i^ do begin
...
var
    i: integer; (* Operand index variable. *)
...
function cval_code ( c: val_ptr ): integer;
...
function cst_code ( c: val ): integer;
    ...
    if stack.top = ref_stk_size then
      ...
      with r^ do begin
        case opcode of
          ...
          array_ref:
            r := base_array;
	  func_call_op:	(* All bets are off without MUCH more detailed analysis *)
...
var
    ...
    ind: integer; (* Operand index variable. *)
    ...
    op_sum: integer; (* The sum of the operand value numbers. *)
