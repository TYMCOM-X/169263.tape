...
(*   +--------------------------------------------------------------+
     ...
     CHANGES:
        ...
        11/7/78  RNF    PASCGR  split  into  PA1CGR  and  PA2CGR   to
                        facilitate  multi-pass  implementation of the
                        compiler.
        8/2/79   RNF    PA1CGR and PA2CGR re-integrated into a single
                        module,  which  is  contained only in pass 1.
