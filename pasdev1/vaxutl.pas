...
(* Compare two reloc_values and determine if they are equal. *)

function reloc_equal ( rel1: reloc_value; rel2: reloc_value ):boolean;
...
public function typ_int_value ( val: integer; vtype: vax_type ): addr_desc;
...
public function cons_vax_type ( scalar_value: integer ): vax_type;
...
procedure push_constant ( scalar_value: integer );
...
public procedure add2_constant ( addr: addr_desc; cons_val: integer );
...
public function add_constant ( addr: addr_desc; constant_value: integer;
